...
class BranchAliasHandlerTest extends TestCase
{
    /** @var ObjectProphecy */
    private $git;
    /** @var BufferedIO */
    ...
    /** @test */
    public function it_sets_a_new_alias()
    {
    ...
    /** @test */
    public function it_gets_current_alias()
    {
    ...
    /** @test */
    public function it_requires_alias_in_a_specific_format()
    {
        $this->git->getGitConfig('branch.master.alias')->willReturn('1.0-dev');
    ...
    private function executeHandler(string $alias = null)
    {
