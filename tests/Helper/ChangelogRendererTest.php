...
9b67df3871e871084d0abef1e0db639d552fc7e commit 2',
    ...
    /** @test */
    public function it_renders_a_changelog_with_categories_excluding_empty(): void
    {
    ...
    /** @test */
    public function it_renders_a_changelog_with_categories_including_empty(): void
    {
        $this->git->getLogBetweenCommits('base', 'head')->willReturn(self::COMMITS);
    ...
    /** @test */
    public function it_renders_a_changelog_without_categories(): void
    {
        $this->git->getLogBetweenCommits('base', 'head')->willReturn(self::COMMITS);
